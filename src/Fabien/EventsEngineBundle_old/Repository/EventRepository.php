...
class EventRepository extends \Doctrine\ORM\EntityRepository
{
  ...
  public function getEventsQuery($city=false,$type=false,$period=false,$region=false,$country=false,$orderField="d.start",$order="ASC",$limit=0,$offset=0,$published=1,$valorisation=0){
