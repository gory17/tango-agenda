...
class Event
{
  ...
  /**
   * @ORM\ManyToMany(targetEntity="Fabien\EventsEngineBundle\Entity\Person", inversedBy="events", cascade={"persist"})
   */
   private $persons;
  ...
  public function __construct()
    {
      ...
      $this->keyEvt = $this->generateKey(20);
    }
     ...
     * @var string
     *
     * @ORM\Column(name="key_event", type="string", length=255, nullable=true)
     */
    private $keyEvt;
     ...
     * @return Event
     */
    public function setKeyEvt($keyEvt)
    {
        $this->keyEvt = $keyEvt;
    ...
    public function generateKey($car){
      $string = "";
