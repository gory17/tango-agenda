...
class DateController extends Controller
{
     ...
     *
     */
    public function viewAction(Date $date,$amp="")
    {

      $em = $this->getDoctrine()->getManager();
      $otherDates=$em->getRepository('FabienEventsEngineBundle:Date')->getOtherDates($date->getEvent()->getId());

      if($amp=="amp"){
        return $this->render('FabienEventsEngineBundle:Dates:viewDate-amp.html.twig', array(
            'date' => $date,'otherDates'=>$otherDates
        ));
      }else{
