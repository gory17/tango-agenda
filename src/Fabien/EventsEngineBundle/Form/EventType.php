...
class EventType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add("mail_creator",EmailType::class,array("label"=>"Votre adresse email","required"=>false,"attr"=>array("placeholder"=>"contact@tangoloso.com")))
        ...
        ->add('dates', CollectionType::class, array(
          ...
          if($options['userRole']=="admin"){
            ...
            ->add('keyEvt',TextType::class, array('required'=>false,'label'=>"Clef"))
            ->add('persons',EntityType::class,array("label"=>"Maestros / DJs",'class'=>'FabienEventsEngineBundle:Person','placeholder' => 'Choose an option','expanded'  => true,
                'multiple'  => true, 'query_builder' => function(\Doctrine\ORM\EntityRepository $person) {
          ...
          $formModifier = function (FormInterface $form, Country $country = null) {
              ...
              $form->add('city',EntityType::class,
                array('label'=>'Ville (ou ville la plus proche présente dans la liste) ii',
